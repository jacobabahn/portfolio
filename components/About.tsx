...
const About = () => {
  return (
    <div className="h-screen flex flex-col relative text-center md:text-left max-w-7xl md:flex-row px-10 justify-evenly items-center">
      <h2 className="absolute bg-[#242424] top-36 2xl:top-40 text-gray-400 text-center text-3xl md:text-4xl tracking-[0.35em] uppercase">About</h2>
      <motion.img
      ...
      <motion.div
        ...
        className=""
      >
        <p className="ml-10 bg-[#242424] text-xl md:text-3xl">
