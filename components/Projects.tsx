...
const Projects = () => {
  return (
    <div className="h-screen flex flex-col relative text-center md:text-left max-w-5xl px-10 justify-evenly items-center">
      ...
      <motion.img
        ...
        className="-mb-20 md:mb-0 md:mt-28 w-96 h-56 rounded-lg shadow-lg object-cover md:w-10/12 md:h-auto m-5"
      />
